...
const UpdateStudentReview = ({ reviewData, refetch, onClose }) => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      // Send update request
      const response = await axiosSecure.patch(`/review/${reviewData._id}`, formData)
      ...
      toast.error(error.response?.data?.message || "An error occurred while updating the review")
    } finally {
      setIsSubmitting(false)
    }
  }
  ...
  return (
    <div className="p-4">
      <div className="flex justify-between items-center mb-6">
        <h2 className="text-2xl font-bold">Update Student Review</h2>
        ...
        <Tabs value={formData.reviewType} className="mb-6">
          <TabsContent value="TEXT" className="mt-0">
            <div>
              ...
              <p className="text-xs text-gray-500 mt-2">
                Use the formatting toolbar to style your text, add links, and more.
              </p>
            </div>
          </TabsContent>
          ...
          <TabsContent value="VIDEO" className="mt-0">
            <div>
              ...
              {formData.reviewVideoUrl && getYouTubeVideoId(formData.reviewVideoUrl) && (
