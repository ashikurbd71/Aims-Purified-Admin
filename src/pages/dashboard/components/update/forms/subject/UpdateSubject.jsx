...
const UpdateSubject = ({ subject, refetch, onClose }) => {
    ...
    onSubmit: async (values) => {
      ...
      try {
        ...
        if (response.status === 200) {
          " Subject Updated successfully:", values;
  ...
  useEffect(() => {
    if (subject) {
      formik.setValues({
        ...
        featuredImg: subject?.featuredImgUrl,
      });
    }
  }, [subject]);
    ...
    <div>
      <form className="mt-3" onSubmit={formik.handleSubmit}>
        ...
        <div className="space-y-2 pt-4">
          ...
          {subject?.featuredImgUrl ? (
            <div className="relative w-24 h-16 ">
              <img
                src={
                  subject?.featuredImgUrl || "https://via.placeholder.com/150"
                }
                alt="Image"
